      ...
      <div className="main-container flex flex-col items-center justify-between gap-12 lg:flex-row">
        <div>
          <RevealAnimation delay={0.1}>
            <span className="badge badge-green mb-5">Why Caartzee</span>
          </RevealAnimation>
          ...
          <RevealAnimation delay={0.3}>
            <p className="lg:max-w-[536px]">
              Caartzee is more than a platform, it’s a complete business operating system 
              designed to unify sales, operations, automation, and intelligence in one powerful infrastructure.
            </p>
          </RevealAnimation>
        ...
        <div className="relative">
          ...
          <RevealAnimation delay={0.7} direction="right" offset={100} useSpring={true} duration={2}>
            <figure className="shadow-3 absolute right-0 bottom-0 w-full max-w-[200px] overflow-hidden rounded-[20px] sm:bottom-10 sm:max-w-[320px] md:bottom-[10%] md:max-w-[395px]">
              <Image src={profitChart} alt="growth-performance" className="h-full w-full dark:hidden" />
              <Image src={profitChartDark} alt="growth-performance" className="hidden h-full w-full dark:block" />
            </figure>
          </RevealAnimation>
