      ...
      <div className="main-container">
        <div className="mx-auto max-w-[804px] space-y-5 text-center">
          <RevealAnimation delay={0.1}>
            <span className="badge badge-cyan">Success Stories</span>
          </RevealAnimation>

          <div className="space-y-3">
            <RevealAnimation delay={0.2}>
              <h2>Trusted by growing brands, operators & commerce leaders</h2>
            </RevealAnimation>

            <RevealAnimation delay={0.3}>
              <p>
                From unified multi-channel selling to automation and real-time analytics, 
                businesses rely on Caartzee to simplify operations and accelerate growth. 
                Here’s what they say about scaling with us.
              </p>
            </RevealAnimation>
          </div>
        </div>
