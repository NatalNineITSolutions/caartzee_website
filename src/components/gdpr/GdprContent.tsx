...
const GdprContent = () => {
  ...
  const dataPurposes: ListItem[] = [
    { id: 'account-management', text: 'To create and manage your Caartzee account' },
  ...
  const dataManagementItems: ListItem[] = [
    ...
    {
      id: 'data-deletion',
      text: 'To request a complete data deletion or data export, simply send an email to: support@Caartzee.com',
    },
  ];
        ...
        <div className="space-y-[70px]">
          ...
          <RevealAnimation delay={0.3}>
            <div className="space-y-3">
              <h2>Caartzee and the general data protection regulation (GDPR)</h2>
              <p>
                ...
                <br />
                <br />
                This page explains how Caartzee implements GDPR principles and ensures that your data is handled
          ...
          <RevealAnimation delay={0.4}>
            <div className="space-y-6">
              <div className="space-y-3">
                ...
                <p>
                  At Caartzee, we are fully committed to respecting your privacy. This page provides a clear overview
                  of:
                </p>
              </div>
          ...
          <RevealAnimation delay={0.5}>
            <div className="space-y-3">
              ...
              <p>
                ...
                Caartzee) must be transparent about what data they collect, how they use it, and how they share it — and
                ...
                residents, including Caartzee.
              </p>
            </div>
          </RevealAnimation>
          {/* How Caartzee Implements GDPR */}
          <RevealAnimation delay={0.3}>
            <div className="space-y-3">
              <h3 className="text-heading-4">How Caartzee Implements GDPR</h3>
              <p>
                Caartzee has always prioritized user data privacy, even before GDPR came into effect. Our core practices
                    ...
                    <span className="text-tagline-1 text-secondary/60 dark:text-accent/60">
                      {item.id === 'data-deletion' ? (
                        <>
                          ...
                          <span className="text-secondary dark:text-accent">support@Caartzee.com</span>
                        </>
                      ) : (
                        item.text
                      )}
