        ...
        <div className="mx-auto w-full max-w-[950px]">
            ...
            <div className="space-y-3 py-8">
              ...
              <p>
                ...
                <Link href="/" className="text-primary-500">
                  https://www.Caartzee.ai
                </Link>{' '}
                website is published by: <br />
                Caartzee is registered in the Trade and Companies Register under number 000000000. <br />
                Registered office: 45 Innovation Avenue, Level 3 – San Francisco, CA 94107, USA <br />
                Intracommunity VAT number: US000000000 <br />
                E-mail address:
                <Link href="mailto:contact@Caartzee.ai" className="text-primary-500">
                  contact@Caartzee.ai
                </Link>
              </p>
            </div>
          ...
          <RevealAnimation delay={0.4}>
            <div className="space-y-3 py-8">
              ...
              <p>
                This website has been designed and developed by Caartzee Design Studio. <br />
                Website:{' '}
                <Link href="/" className="text-primary-500">
                  https://www.Caartzee.design
                </Link>
              </p>
            </div>
          </RevealAnimation>
