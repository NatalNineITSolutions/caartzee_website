          ...
          <div className="mx-auto w-[95%] max-w-[850px] space-y-4 text-center">
            <RevealAnimation delay={0.3}>
              <h2>
                ...
                Scale Effortlessly with Caartzee.
              </h2>
            </RevealAnimation>
            <RevealAnimation delay={0.4}>
              <p>
                Caartzee Sales Agent connects Amazon, Flipkart, and your Caartzee store into one smart dashboard.
                Manage inventory, enhance product visuals with AI, and track performance in real time.
              </p>
            </RevealAnimation>
          </div>
        </div>
          ...
          <div className="lp:max-w-[1416px] relative mx-auto max-w-[980px] lg:max-w-[1140px] xl:max-w-[1280px]">
            ...
            <RevealAnimation delay={0.4} direction="left">
              <figure className="absolute -top-10 left-10 z-20 max-w-[120px] overflow-hidden rounded-[20px] sm:max-w-[200px] lg:top-20 lg:left-20 lg:max-w-[282px] xl:top-1/2 xl:left-0 xl:-translate-y-1/2">
                <Image src={hero1} alt="sales hero" className="block h-full w-full object-cover dark:hidden" />
                <Image src={hero1Dark} alt="sales hero" className="hidden h-full w-full object-cover dark:block" />
              </figure>
            </RevealAnimation>

            {/* Center image */}
            <figure className="relative z-10 mx-auto max-w-[860px] overflow-hidden rounded-[20px] px-10 lg:px-0 xl:mx-0 xl:translate-x-[36%]">
              <Image src={hero2} alt="sales hero" className="h-full w-full rounded-[20px] object-cover lg:rounded-none" />
            </figure>
            ...
            <RevealAnimation delay={0.5} direction="right">
              <figure className="shadow-3 absolute right-0 bottom-0 z-20 max-w-[150px] overflow-hidden rounded-[20px] sm:right-14 sm:bottom-14 sm:max-w-[200px] lg:right-20 lg:bottom-5 lg:max-w-[320px] xl:top-1/2 xl:-right-0 xl:bottom-auto xl:-translate-y-1/2">
                <Image src={hero3} alt="sales hero" className="block h-full w-full dark:hidden" />
                <Image src={hero3Dark} alt="sales hero" className="hidden h-full w-full dark:block" />
              </figure>
            </RevealAnimation>
          </div>
        </div>
...
SalesHero.displayName = 'SalesHero';
