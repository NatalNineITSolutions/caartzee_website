...
import faqImgDark from '@public/images/ns-img-dark-52.png';
import Image from 'next/image';
import RevealAnimation from '../animation/RevealAnimation';
import FaqAccordion from './SalesFaqAccordion';

const SalesFaq = () => {
  return (
    <section
      className="dark:bg-background-6 bg-white py-[100px] lg:py-[150px] xl:py-[200px]"
      aria-label="Sales Frequently Asked Questions"
    >
          ...
          <div className="space-y-14 text-center lg:text-left">
            <div className="space-y-5">
              ...
              <RevealAnimation delay={0.2}>
                <h2 className="mx-auto lg:mx-0 lg:max-w-[439px]" id="sales-faq-heading">
                  Sales Navigator FAQs
                </h2>
              </RevealAnimation>
            </div>
            {/* faq accordion */}
          ...
          <RevealAnimation delay={0.5}>
            <figure className="relative w-full max-w-[684px] overflow-hidden lg:max-w-[500px] xl:max-w-[684px]">
              <Image
                ...
                src={faqImg}
                alt="Sales assistance illustration"
                loading="lazy"
              />
              <Image
