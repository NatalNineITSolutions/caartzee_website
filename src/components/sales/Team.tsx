...
const SalesTeam = () => {
  return (
    <section className="dark:bg-background-5 py-[100px] lg:py-[150px] xl:py-[100px]">
      <div className="main-container">
        <div>
          {/* team heading */}
          <div className="mx-auto mb-[70px] max-w-[620px] text-center md:w-full">
            <RevealAnimation delay={0.1}>
              <span className="badge badge-green mb-5">Sales Team</span>
            </RevealAnimation>
            <RevealAnimation delay={0.2}>
              <h2 className="mb-3">Meet the experts driving Caartzee’s sales innovation</h2>
            </RevealAnimation>
            <RevealAnimation delay={0.3}>
              <p>
                Our dedicated sales team combines marketplace expertise and AI‑driven strategies to help sellers grow smarter and faster.
              </p>
            </RevealAnimation>
          </div>
