          ...
          <div className="w-full lg:w-1/2">
            <div className="mb-10 space-y-3 px-4 text-center sm:px-0 md:text-left lg:mb-14">
              <RevealAnimation delay={0.1}>
                <h2>
                  Talk Less, <span className="text-primary-500">Sell More.</span>
                </h2>
              </RevealAnimation>
              <RevealAnimation delay={0.2}>
                <p className="lg:max-w-[462px]">
                  Caartzee Snap handles product catalogs, pricing details, stock updates, order confirmations, and payment links  automatically inside WhatsApp.
                </p>
              </RevealAnimation>
            </div>
            ...
            <div className="mb-8 space-y-3 px-4 text-center sm:px-0 md:text-left lg:mb-14">
              <RevealAnimation delay={0.3}>
                <h3 className="md:text-heading-3 lg:text-heading-2">
                  Your Brand, <span className="text-primary-500">Amplified.</span>
                </h3>
              </RevealAnimation>
              <RevealAnimation delay={0.4}>
...
With Caartzee Snap, your customers can browse products, place orders, and pay directly inside WhatsApp.
