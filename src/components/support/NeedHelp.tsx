import support from '@public/images/ns-img-370.png';
        ...
        <div className="mb-[70px] space-y-14 text-center">
          <div className="space-y-3">
            <RevealAnimation delay={0.3}>
              <h2>Need help with Caartzee?</h2>
            </RevealAnimation>
            <RevealAnimation delay={0.4}>
              <p>
                Welcome to the Caartzee Support Center! We&apos;re ready to assist you if you have an issue or a
                question.
              </p>
            </RevealAnimation>
          </div>
