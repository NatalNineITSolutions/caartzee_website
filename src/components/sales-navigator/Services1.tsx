          ...
          <div className="mx-auto max-w-[810px] space-y-5 text-center lg:w-full">
            ...
            <div className="space-y-3">
              <RevealAnimation delay={0.2}>
                <h2>Powerful commerce solutions built for Caartzee sellers.</h2>
              </RevealAnimation>
              <RevealAnimation delay={0.3}>
                <p className="mx-auto max-w-[582px] sm:w-full">
                  From marketplace integration to AI-powered product enhancement, CaartZee provides everything you need to scale your online business efficiently.
                </p>
              </RevealAnimation>
            </div>
          </div>
