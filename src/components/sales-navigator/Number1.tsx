            ...
            <div className="space-y-3">
              ...
              <RevealAnimation delay={0.3}>
                <p className="max-w-[780px]">
                  Our results reflect a strong commitment to innovation, helping sellers scale faster with AI-powered tools,
                  real-time insights, and seamless marketplace integration.
                </p>
              </RevealAnimation>
            </div>
          </div>
