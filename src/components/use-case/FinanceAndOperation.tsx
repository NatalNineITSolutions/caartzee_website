        ...
        <div className="space-y-[70px]">
          ...
          <div className="space-y-3">
            ...
            <RevealAnimation delay={0.2}>
              <p>
                Caartzee is designed to serve a wide range of teams and industries. Whether you&apos;re managing data,
                scaling operations, optimizing finances, or streamlining customer experiences—Caartzee is the platform
                that grows with you.
              </p>
            </RevealAnimation>
          </div>
            ...
            <div className="space-y-2">
              ...
              <RevealAnimation delay={0.2}>
                <p>
                  ...
                  <br />
                  From roadmap planning to feature tracking, product teams use Caartzee to keep everyone aligned and
            ...
            <div className="space-y-2">
              ...
              <RevealAnimation delay={0.2}>
                <p>
                  ...
                  <br />
                  Caartzee helps marketers connect strategy to results, with built-in analytics and collaborative tools
            ...
            <div className="space-y-2">
              ...
              <RevealAnimation delay={0.2}>
                <p>
                  ...
                  <br />
                  Caartzee gives leadership teams the visibility they need across every department—all in one unified
                  view.
                </p>
              </RevealAnimation>
            </div>
            ...
            <div className="space-y-2">
              ...
              <RevealAnimation delay={0.2}>
                <p>
                  ...
                  <br />
                  Even small teams can get big results. Use Caartzee to manage your pipeline, track progress, and
              ...
              <RevealAnimation delay={0.5}>
                <li className="flex items-center gap-2">
                  ...
                  <p>
                    ...
                    <span className="text-secondary">support@Caartzee.com</span>
                  </p>
                </li>
              </RevealAnimation>
            </ul>
