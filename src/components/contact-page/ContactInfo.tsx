...
const contactInfoItems = [
  {
    ...
    icon: homeIcon,
    title: 'Our Address',
    content: '99/A, 1st Floor ,Dr. Shammy Eye care,PWD Road Chettikulam Nagercoil - 629002,Tamil Nadu,India',
  ...
  },
  {
    ...
    icon: mailIcon,
    title: 'Email Us',
    content: 'info@natalnine.com',
    link: 'mailto:info@natalnine.com',
