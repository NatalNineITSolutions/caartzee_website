...
export const metadata: Metadata = {
  ...
  description: 'Ship your products with the best in-house courier services. Reach 29,000+ pin codes with automated shipping and discounted rates.',
};
  ...
  return (
    <main className="bg-white dark:bg-background-8">
      ...
      <section className="bg-white py-20 dark:bg-background-8 ">
        <div className="main-container text-center dark:invert">
          <RevealAnimation delay={0.1}>
            <div className="rounded-[40px] bg-primary-500 p-16 text-white shadow-2xl ">
              <h2 className="mb-6 text-heading-3 font-semibold md:text-heading-2 text-white">
                Easy delivery just a few clicks away!
              </h2>
              <p className="mb-10 text-xl opacity-80 text-white">
