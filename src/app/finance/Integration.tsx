      ...
      <div className="main-container">
        <div className="text-center mb-[70px]">
          <RevealAnimation delay={0.1}>
            <span className="badge badge-yellow-v2 mb-5"> Integrations </span>
          </RevealAnimation>

          <RevealAnimation delay={0.2}>
            <h2 className="mb-3">
              Seamlessly integrates with your existing <br className="hidden lg:block" />
          ...
          <RevealAnimation delay={0.3}>
            <p className="mb-8 lg:max-w-[620px] mx-auto">
              Connect your favorite tools like Tally, QuickBooks, Zoho Books, and SAP to automate data syncing and ensure error-free GST filing.
            </p>
          </RevealAnimation>
        </div>
