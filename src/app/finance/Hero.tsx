...
import boldArrowUpRightImage from '@public/images/icons/arrow-up-right.svg';
        ...
        <div className="mx-auto mb-[70px] flex max-w-[900px] flex-col items-center">
          <div className="mb-5">
            <RevealAnimation delay={0.1}>
              <span className="badge badge-yellow-v2 opacity-0">Trusted by 50k+ CAs & Businesses</span>
            </RevealAnimation>
          </div>

          <div className="mb-14 text-center">
            <RevealAnimation delay={0.2}>
              <h1 className="mb-4 opacity-0">Automate Your GST & Financial Workflows</h1>
            </RevealAnimation>

            <RevealAnimation delay={0.3}>
              <p className="text-tagline-1 mx-auto max-w-[720px] opacity-0">
                Streamline GST compliance, automate invoicing, and eliminate manual data entry. Gain real-time financial insights and ensure 100% tax accuracy.
              </p>
            </RevealAnimation>
          </div>
              ...
              <RevealAnimation delay={0.7} instant={true}>
                <div className="bg-background-2 dark:bg-background-6 relative z-0 flex items-center justify-center overflow-hidden rounded-[20px] p-[26px] opacity-0 backdrop-blur-[20px] max-md:min-h-[320px]">
                  ...
                  <div className="group text-center">
                    ...
                    <h6 className="text-secondary dark:text-accent mb-1">100% GST Compliance</h6>
                    <p className="text-secondary/60 dark:text-accent/60">Auto-reconcile invoices and avoid penalties</p>
                  </div>
                </div>
              </RevealAnimation>
            </div>
            ...
            <RevealAnimation delay={0.8} instant={true}>
              <div className="bg-background-2 dark:bg-background-6 flex justify-between rounded-[20px] p-6 opacity-0 backdrop-blur-[20px] max-sm:flex-col max-sm:gap-y-8">
                <div className="max-sm:text-center">
                  <h5 className="text-secondary dark:text-accent mb-1">Tax Portals Connected</h5>
