      ...
      <div className="mx-auto max-w-[1440px] px-4 md:px-[67px]">
        ...
        <div className="mb-14 text-center lg:mb-[70px]">
          <RevealAnimation delay={0.1}>
            <span className="badge badge-green-v2 mb-5"> Testimonials </span>
          </RevealAnimation>

          <RevealAnimation delay={0.2}>
            <h2 className="mx-auto mb-3 max-w-[750px]">See how leading CA firms & CFOs are growing with our automation</h2>
          </RevealAnimation>
        </div>
      </div>
